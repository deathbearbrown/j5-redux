...
describe("Game", () => {
  ...
  it("has 3 listeners with unsubscribe properties", function(){
    expect(game).to.have.property('unsubscribe');
    expect(game).to.have.property('unsubscribeNewGame');
    expect(game).to.have.property('unsubscribeGameOver');
  });
